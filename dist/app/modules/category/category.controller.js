...
const getSingleCategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield category_service_1.CategoryService.getSingleCategory(req.params.categoryId);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const updateSingleCategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield category_service_1.CategoryService.updateSingleCategory(req.params.categoryId, req.body);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const deleteSingleCategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield category_service_1.CategoryService.deleteCategory(req.params.categoryId);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
