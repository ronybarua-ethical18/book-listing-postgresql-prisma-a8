...
const signup = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const hashPassword = yield bcrypt_1.default.hash(password, Number(config_1.default.bycrypt_salt_rounds));
...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isPasswordMatched = yield bcrypt_1.default.compare(requestPassoword, isUserExist.password);
